...
public class GerenciadorPoliticos {
    ...
    public GerenciadorPoliticos(MediadorDebate mediadorDebate) {
    ...
    public PoliticoColaborador criarPolitico(String nome, String partido, int numero, Mediador mediador) {
        ...
        novoPolitico.getMicrofone().setMediadorDebate(mediadorDebate);
        politicos.add(novoPolitico);
        return novoPolitico;
    }

    public void adicionarPolitico(PoliticoColaborador politico) {
        politico.getMicrofone().setMediadorDebate(mediadorDebate);
        politicos.add(politico);
    }

    public PoliticoColaborador obterPolitico(String nome) {
        for (PoliticoColaborador politico : politicos) {
            if (politico.getNome().equalsIgnoreCase(nome)) {
                return politico;
            }
        }
        return null;
    ...
    public void listarPoliticos() {
        ...
        for (PoliticoColaborador politico : politicos) {
            System.out.println("- " + politico.getNome()
                    + " | Partido: " + politico.getPartido()
                    + " | Número: " + politico.getNumero());
        }
    }
