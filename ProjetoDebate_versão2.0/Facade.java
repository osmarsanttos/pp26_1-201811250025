public class Facade {
    ...
    public void cadastrarUsuarioOperador(String nome, String login) {
        usuarioOperador = new UsuarioOperadorBuilder().setNome(nome).setLogin(login).build();
    ...
    public void clonarUsuarioOperador() {
        if (usuarioOperador == null) {
            System.out.println("Nenhum usuário operador cadastrado.");
            return;
        }
        UsuarioOperador copia = usuarioOperador.clonar();
        logger.registerLog("Usuário operador clonado: " + copia.getNome());
        System.out.println("Clone do usuário operador criado: " + copia.getNome());
    }
    ...
    public void clonarPolitico(String nomePoliticoBase, String novoNome) {
        ...
        if (gerenciaPoliticos.obterPolitico(novoNome) != null) {
            System.out.println("Já existe um político com esse nome: " + novoNome);
            return;
        }
    ...
    public void cadastrarEleitor(String nomeEleitor, String nomeCandidato) {
        ...
        Eleitor eleitor = new EleitorBuilder().setNome(nomeEleitor).setCandidatoPreferido(candidato).build();
    ...
    public void listarPoliticos() { gerenciaPoliticos.listarPoliticos(); }
    ...
    public void getLogs() { logger.getAllLogs(); }
}
