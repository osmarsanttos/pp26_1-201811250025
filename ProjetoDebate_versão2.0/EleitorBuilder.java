public class EleitorBuilder {
    ...
    public Eleitor build() {
        if (nome == null || nome.isBlank()) throw new IllegalArgumentException("Nome do eleitor é obrigatório.");
        if (candidatoPreferido == null) throw new IllegalArgumentException("Candidato preferido é obrigatório.");
